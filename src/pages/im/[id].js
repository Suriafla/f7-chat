...
export default function Msg (props) {
    ...
    const [messagesData, setMessagesData] = useState([
      ...
      },
      {
        ...
        type: 'received',
        text: 'Hello!',
        avatar: 'https://whatsapp-f7-react.uiinitiative.com/avatars/mark-zuckerberg.jpg',
      },
      {
        type: 'sent',
    ...
    return (
      ...
      <Page>
        ...
        <Navbar title={users[id].name} backLink="Back"></Navbar>
        ...
        <Messages>
          ...
          {messagesData.filter(el => el.name == users[id].name || el.name == null).map((message, index) => (
            <Message
              key={index}
              type={message.type}
              image={message.image}
